...
public class JDBCNodeStoreTest {
	...
	public void testGetNodeItems() throws Exception {
		...
		ResultSet<NodeItem> result = store.getNodeItems(TEST_SERVER1_NODE1_ID);
		...
		Iterator<NodeItem> it = result.iterator();
		...
		assertFalse("Too many items were returned", it.hasNext());
	}
	...
	public void testGetNodeItemsForUnknownNodeReturnsEmptyIterator()
		...
		ResultSet<NodeItem> result = store.getNodeItems(TEST_SERVER1_NODE2_ID);

		assertFalse("Items were returned but none were expected", result
				.iterator().hasNext());
	}
	...
	public void testGetNodeItemsWithLimits() throws Exception {
		...
		ResultSet<NodeItem> result = store.getNodeItems(TEST_SERVER1_NODE1_ID,
				TEST_SERVER1_NODE1_ITEM1_ID, 3);

		String[] expectedNodeIds = { TEST_SERVER1_NODE1_ITEM4_ID,
				TEST_SERVER1_NODE1_ITEM3_ID, TEST_SERVER1_NODE1_ITEM2_ID, };
		String[] expectedEntryContent = { TEST_SERVER1_NODE1_ITEM4_CONTENT,
				TEST_SERVER1_NODE1_ITEM3_CONTENT,
				TEST_SERVER1_NODE1_ITEM2_CONTENT, };
